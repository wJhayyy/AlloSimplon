...
<nav class="shadow-lg mb-16 z-10 relative">
    ...
    <div class="flex justify-between">
      <div class="flex space-x-7">
        ...
        <div class="hidden md:flex items-center space-x-1">
          <a href="content/film.php" class="py-4 px-2 text-fourth font-semibold hover:text-secondary  transition duration-300">Nos films</a>
          <a href="content/contact.php" class="py-4 px-2 text-fourth font-semibold hover:text-secondary  transition duration-300">Contact</a>
          <a href="content/about.php" class="py-4 px-2 text-fourth font-semibold hover:text-secondary  transition duration-300">A propos</a>
          <?php

        if(!isset($_SESSION['email'])){

         echo '<div class="hidden md:flex items-center space-x-3 ">';
         echo   '<a href="content/signup.php" class="py-2 px-2 font-medium text-fourth font-semibold rounded hover:bg-fifth hover:text-secondary transition duration-300">Se connecter</a>';
         echo   '<a href="content/signin.php" class="py-2 px-2 font-medium text-fourth font-semibold rounded hover:bg-fifth hover:text-secondary transition duration-300">Sinscrire</a>';
        } else {
            
           echo '<button data-modal-target="defaultModal" data-modal-toggle="defaultModal" class="block h-min mt-auto mb-auto font-medium text-lg text-fourth hover:text-secondary focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 transition duration-300" type="button">
  ...
  <div class="hidden mobile-menu z-10">
    <ul class="">
      <li><a href="content/film.php" class="block text-sm px-2 py-4 bg-fourth hover:bg-secondary text-slate-800 transition duration-300">Nos films</a></li>
      <li><a href="content/contact.php" class="block text-sm px-2 py-4 bg-fourth hover:bg-secondary text-slate-800 transition duration-300">Contact</a></li>
      <li><a href="content/about.php" class="block text-sm px-2 py-4 bg-fourth hover:bg-secondary text-slate-800 transition duration-300">A propos</a></li>
      <li><a href="content/signin.php" class="block text-sm px-2 py-4 bg-fourth hover:bg-secondary text-slate-800 transition duration-300">Se connecter</a></li>
      <li><a href="content/signup.php" class="block text-sm px-2 py-4 bg-fourth hover:bg-secondary text-slate-800 transition duration-300">S'inscrire</a></li>
    </ul>
  </div>
</nav>
...
<div id="defaultModal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full">
              <div class="relative w-full h-full max-w-2xl md:h-auto">
                  ...
                  <div class="relative bg-slate-900 rounded-lg shadow dark:bg-gray-700">
                      ...
                      <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                          <h3 class="text-xl font-semibold text-secondary dark:text-white m-auto">
                              Profil
                          </h3>
                      ...
                      <div class="p-6 space-y-6">
                          <p class="text-base leading-relaxed text-secondary dark:text-gray-400">
          ...
          if(isset($_SESSION) && ($_SESSION ['id_role'] == 2)){ ?>
            <button class="z-50 sticky text-secondary bg-fourth top-20 m-auto rounded-full pl-4 pr-4 p-2 pb-2 block hover:bg-fifth transition duration-300"><a href="content/crud.php">Panel Admin</a></button>
          <?php
          }
          ?>

          <!--<button type="button" class="z-50 sticky text-secondary bg-fourth top-20 m-auto rounded-full pl-4 pr-4 p-2 pb-2 block hover:bg-fifth transition duration-300"><a href="content/crud.php">Panel Admin</a>-->
...
<a class="lien-esp-pa pl-2 pr-2" href="content/film.php" style="width: fit-content;display: block;margin-left: auto;margin-right: auto;">
  <h2 class="voir-plus-link text-center text-secondary bg-fourth rounded-full hover:bg-fifth transition duration-300">Voir notre liste de film</h2>
</a>

<!-- Cards -->


<h2 class="z-10 relative text-center text-2xl p-4 mt-16 bg-fifth w-fit m-auto rounded-full">A l'affiche 
...
<div class="card-accueil grid mt-20">
  ...
  <div class=" bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 w-3/6 z-10 relative card-film">
    ...
    <div class="p-5">
        ...
        <a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-secondary bg-fourth rounded-lg hover:bg-fifth focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 transition duration-300">
            Read more
...
<footer class="bg-third dark:bg-gray-900 mt-40">
  <div class="mx-auto w-full container p-4 sm:p-6">
      <div class="md:flex md:justify-between">
        ...
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
                ...
                <ul class="text-secondary dark:text-gray-400">
                    <li class="mb-4">
            ...
            <div>
                <h2 class="mb-6 text-sm font-semibold text-secondary uppercase dark:text-white">Retrouvez-nous</h2>
                <ul class="text-secondary dark:text-gray-400">
                    <li class="mb-4">
            ...
            <div>
                <h2 class="mb-6 text-sm font-semibold text-secondary uppercase dark:text-white">Légale</h2>
                <ul class="text-secondary dark:text-gray-400">
                    <li class="mb-4">
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-secondary sm:text-center dark:text-gray-400">© 2023 <a href="index.php" class="hover:underline">AlloSimplon™</a>. All Rights Reserved.
        </span>
        <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a href="#" class="text-secondary hover:text-gray-900 dark:hover:text-white">
